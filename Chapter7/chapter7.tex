...
All the analyzed results about the overall handover delay related to LISP and the handover overhead are presented in Fig.~\ref{handover_delay_overhead_bar}.
\begin{figure}[!t]
