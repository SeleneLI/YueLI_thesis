...
\yue{Mention adapt to ns-3.27 and encode for Wireshark.}
...
\begin{figure*}[!t]
	...
	\caption{Illustration of LISP encapsulation and decapsulation} \yue{Figure is not completed}
